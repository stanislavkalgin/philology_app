...
class Ui_answer_edit_window(object):
    def setupUi(self, answer_edit_window):
        ...
        self.button_metaphor = QtWidgets.QPushButton(answer_edit_window)
        ...
        self.button_epithet = QtWidgets.QPushButton(answer_edit_window)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.button_repeat = QtWidgets.QPushButton(answer_edit_window)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.button_repeat.setStyleSheet("color: rgb(0, 170, 0);")
        self.button_repeat.setObjectName("button_repeat")
        self.verticalLayout.addWidget(self.button_repeat)
    ...
    def retranslateUi(self, answer_edit_window):
        ...
        self.button_metaphor.setText(_translate("answer_edit_window", "Метафора"))
        self.button_epithet.setText(_translate("answer_edit_window", "Эпитет"))
        self.button_repeat.setText(_translate("answer_edit_window", "Повтор"))
